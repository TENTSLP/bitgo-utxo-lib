...
module.exports = {
  ...
  // https://github.com/TENTOfficial/TENT/blob/master/src/main.cpp
  // https://github.com/TENTOfficial/TENT/blob/master/src/chainparams.cpp
  tent: {
    ...
    consensusBranchId: {
      1: 0x00,
      2: 0x00,
      3: 0x5ba81b19, // Overwinter
      4: 0x76b809bb // same consensusBranchId since Sapling till Wakanda
    },
    coin: coins.TENT
  },
  tentTest: {
