...
const fixtures = require('../../fixtures/forks/tent/block_custom')

describe('Block (tent)', function () {
  ...
  describe('toBuffer/toHex', function () {
    fixtures.valid.forEach(function (f) {
      ...
      it('exports ' + f.description, function () {
        assert.strictEqual(block.toHex(true), f.hex.slice(0, Block.TENT_HEADER_BYTE_SIZE * 2))
